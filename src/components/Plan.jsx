...
const Plan = () => {
  return (
    <div className="max-w-[1400px] m-auto py-8 px-4 grid lg:grid-cols-2 gap-4">
      {/* left side */}
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">
          Start planning your dream vacation today with our easy-to-use tools
          and personalized suggestions.
        </p>
        <p className="pb-6">
          We’re here to help you create unforgettable experiences. Whether
          you’re an adventure seeker, a beach lover, or someone who enjoys quiet
          escapes
        </p>
